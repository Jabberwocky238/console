...
```bash
# Read inner guidelines index (if applicable)
cat .trellis/spec/inner/index.md

# Read outer guidelines index (if applicable)
cat .trellis/spec/outer/index.md
```

**Why read both?**
- Understand the full project architecture
- Know coding standards for the entire codebase
- See how outer and inner interact
...
**outer Task**:
```bash
cat .trellis/spec/outer/hook-guidelines.md      # For hooks
cat .trellis/spec/outer/component-guidelines.md # For components
cat .trellis/spec/outer/type-safety.md          # For types
```

**inner Task**:
```bash
cat .trellis/spec/inner/database-guidelines.md   # For DB operations
cat .trellis/spec/inner/type-safety.md           # For types
cat .trellis/spec/inner/logging-guidelines.md    # For logging
```
...
|   |-- inner/        # inner guidelines (if applicable)
|   |   |-- index.md               # Start here - guidelines index
|   |   \-- *.md                   # Topic-specific docs
|   |-- outer/         # outer guidelines (if applicable)
|   |   |-- index.md               # Start here - guidelines index
|   |   \-- *.md                   # Topic-specific docs
...
**outer Development** (if applicable):
```bash
# Read index first, then specific docs based on task
cat .trellis/spec/outer/index.md
```

**inner Development** (if applicable):
```bash
# Read index first, then specific docs based on task
cat .trellis/spec/inner/index.md
```
...
- See `.trellis/spec/inner/quality-guidelines.md` for inner
- See `.trellis/spec/outer/quality-guidelines.md` for outer
...
```
spec/
|-- outer/           # outer docs (if applicable)
|   |-- index.md        # Start here
|   \-- *.md            # Topic-specific docs
|-- inner/            # inner docs (if applicable)
|   |-- index.md        # Start here
|   \-- *.md            # Topic-specific docs
\-- guides/             # Thinking guides
    |-- index.md        # Start here
